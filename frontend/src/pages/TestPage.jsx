...
import { Upload, Monitor, Smartphone, Sun, Moon, Shuffle, X, Crown, Lock } from 'lucide-react';
  ...
  return (
    <div className={`${isMobile ? 'flex gap-2' : 'flex flex-col'} cursor-pointer group`}>
      ...
      <div className={`${isMobile ? 'flex-1 py-1' : 'mt-3'} flex gap-3`}>
        ...
        {!isMobile && (
          <div className={`w-9 h-9 rounded-full flex items-center justify-center text-xs font-semibold flex-shrink-0 overflow-hidden ${isLightMode ? 'bg-red-600 text-white' : 'bg-slate-700 text-white'
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3
            className={`font-medium line-clamp-2 mb-1 ${isLightMode ? 'text-[#0f0f0f]' : 'text-[#f1f1f1]'
              }`}
            style={{
          ...
          <p
            className={`mb-0.5 font-normal ${isLightMode ? 'text-[#606060]' : 'text-[#aaaaaa]'
              }`}
            style={{
              fontFamily: 'Roboto, Arial, sans-serif',
              fontSize: '12px',
          ...
          <p
            className={`font-normal ${isLightMode ? 'text-[#606060]' : 'text-[#aaaaaa]'
              }`}
            style={{
              fontFamily: 'Roboto, Arial, sans-serif',
              fontSize: '12px',
          ...
          <div className="flex h-[calc(100vh-80px)] overflow-hidden">
            ...
            >
              ...
              <div className="p-5 space-y-4 flex-1 overflow-y-auto">
                ...
                {!isPro && (
                  <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/40 rounded-xl p-4 mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      <Lock size={16} className="text-purple-400" />
                      <span className="text-white font-semibold text-sm" style={{ fontFamily: 'Geist Sans, sans-serif' }}>
                        Pro Özellik
                      </span>
                    </div>
                    <p className="text-slate-300 text-xs mb-3" style={{ fontFamily: 'Geist Sans, sans-serif' }}>
                      A/B test özelliğini kullanmak için Pro'ya yükseltin.
                    </p>
                    <Button
                      onClick={() => navigate('/pricing')}
                      className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-sm h-9 flex items-center justify-center gap-2"
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    {uploadedThumbnails.length < 3 && (
                      ...
                      >
                        <Upload size={16} className={isPro ? 'text-blue-400 mb-0.5' : 'text-slate-500 mb-0.5'} />
                        <p className={`text-[9px] font-medium ${isPro ? 'text-white' : 'text-slate-500'}`} style={{ fontFamily: 'Geist Sans, sans-serif' }}>
                          {isPro ? 'Ekle' : 'Pro'}
                        </p>
                      </div>
                    )}
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Input
                      ...
                      disabled={!isPro}
                      className={`bg-slate-800 border-slate-600 text-white text-xs h-8 ${!isPro ? 'opacity-50 cursor-not-allowed' : ''}`}
                      style={{ fontFamily: 'Geist Sans, sans-serif' }}
                    />
                    <Input
            ...
            <div className={`flex-1 overflow-y-auto ${isLightMode ? 'bg-white' : 'bg-[#0f0f0f]'
              }`}>
              <div className={`${isMobile ? 'max-w-md mx-auto' : 'max-w-7xl mx-auto'
                } p-6`}>
                {/* Simulator Header */}
                <div className="mb-6">
                  <h3 className={`text-xl font-bold mb-1 ${isLightMode ? 'text-slate-900' : 'text-white'
                ...
                {simulationList.length > 0 && (
                  <div className={`mt-8 text-center text-sm ${isLightMode ? 'text-slate-600' : 'text-slate-400'
                    }`} style={{ fontFamily: 'Geist Sans, sans-serif' }}>
